// Staking Schema for Jaime.Capital SOL to Jaime Token Staking
...
export interface StakingConfig {
  ...
  jaimeTokenAddress: string; // Jaime token mint address
...
// Default Jaime.Capital theme configuration
...
export const defaultStakingConfig: StakingConfig = {
  ...
  jaimeTokenAddress: 'EtpQtF2hZZaEMZTKCp15MmMtwjsXJGz4Z6ADCUQopump',
